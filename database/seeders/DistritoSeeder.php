...
class DistritoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $distritos = [
            ...
            [1338, 'SAN VICENTE DE CAÑETE', 132],
            [1339, 'ASIA', 132],
            [1340, 'CALANGO', 132],
            [1341, 'CERRO AZUL', 132],
            [1342, 'CHILCA', 132],
        ...
        foreach ($distritos as $distrito) {
            DB::table('distrito')->insert([
                'id' => $distrito[0],      // Primer valor del arreglo es el ID
                'nombre' => $distrito[1],  // Segundo valor del arreglo es el nombre
                'provincia_id' => $distrito[2],  // Tercer valor del arreglo es el ID del departamento
            ]);
        }
    }
}
