...
@yield('content')
<footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top" style="background-color: #034833;">
    ...
    <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
      <li class="ms-3"><a class="text-body-secondary text-white" href="#"><i class="fab fa-tiktok" width="24" height="24"><use xlink:href="#twitter"></use></i></a></li>
      <li class="ms-3"><a class="text-body-secondary text-white" href="#"><i class="fab fa-instagram" width="24" height="24"><use xlink:href="#instagram"></use></i></a></li>
      <li class="ms-3"><a class="text-body-secondary text-white" href="#"><i class="fab fa-facebook-f" width="24" height="24"><use xlink:href="#facebook"></use></i></a></li>
    </ul>
  </footer>
<!-- Logout Modal-->
